...
/**
 * ywap-marikina theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { ywapMarikinaTheme } from './ywap-marikina';
 *   import './ywap-marikina.css';
 */
export const ywapMarikinaTheme = {
  name: 'ywap-marikina',
  __built: true,
  tokens: {
  ...
  __localTokenOwners: {
    ...
    "--color-mesh-base": "ywap-marikina",
    "--color-mesh-highlight": "ywap-marikina",
    "--color-mesh-shadow": "ywap-marikina",
    "--color-mesh-depth": "ywap-marikina",
    "--color-mesh-cyan": "ywap-marikina",
    "--color-mesh-gold": "ywap-marikina",
    "--color-mesh-orange": "ywap-marikina",
    "--color-mesh-blue": "ywap-marikina",
    "--color-mesh-peach": "ywap-marikina",
    "--color-mesh-yellow": "ywap-marikina",
    "--color-mesh-lavender": "ywap-marikina"
  },
  __localTokenLineage: ["neutral","ywap-marikina"],
  components: {
    "heading": {
      "level:1": {
